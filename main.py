...
def main():
    ...
    if st.button("Geschichtstitel erhalten"):
        prompt = f"Erstelle bitte 5 kurze Titel für Geschichten in denen es um folgendes geht:'{story_settings[chosen_story]}'. Bitte nenne in 2 Titeln den Namen einer der genannten Charaktere. Erstelle sie als Liste, einen Titel je Zeile. Bitte schreibe nur die Titel, keine Erläuterungen und benutze keine Anführungszeichen."
