...
# Story Settings
story_settings = {
    '''Tief inmitten der grünen Wiesen, versteckt unter dem schützenden Schatten eines uralten Baumstumpfes, 
    ...
    Weisheiten und lehrreicher Momente, die die Kinder sanft in den Schlaf begleiten.''' : "Eine Mäusegeschichte",
